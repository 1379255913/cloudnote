...
import NewNote from '../NewNote/index.vue'
import useSettingsStore from '@/store/modules/settings'
const settingsStore = useSettingsStore()
import useMenuStore from '@/store/modules/menu'
const menuStore = useMenuStore()
import useKeepNewNote from '@/store/modules/newNote'
const useNewNote = useKeepNewNote()
import {storeToRefs} from 'pinia'
const {isActive} = storeToRefs(useNewNote)
const switchMenu = inject('switchMenu')
const change = (flag)=>{
    useNewNote.isActive = flag
}
</script>
